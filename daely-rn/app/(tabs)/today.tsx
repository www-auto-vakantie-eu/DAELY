...
function getAuroraTokens(activeThemeId: string) {
  ...
  return {
    ...
    auroraTitle: currentTheme.colors.auroraTitle || (isRetro ? '#1B2E6B' : isSahara ? '#7A4E24' : isForce ? '#7F1D1D' : '#1E1B4B'),
    auroraSubtitle: currentTheme.colors.auroraSubtitle || (isRetro ? '#B42318' : isSahara ? '#9A6B3A' : isForce ? '#B91C1C' : '#4A3A8C'),
    ...
    recoveryIconColor: isClassic ? '#0EA5E9' : isForce ? '#DC2626' : isSahara ? '#C89B72' : isRetro ? '#1B2E6B' : '#8B5CF6',
