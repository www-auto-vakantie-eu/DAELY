...
export default function TrainingPreferencesScreen() {
  ...
  const [preferences, setPreferences] = useState(user?.trainingPreferences || '');
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.label}>Wat zijn je trainingsvoorkeuren?</Text>
      <TextInput
        style={styles.input}
        value={preferences}
        onChangeText={setPreferences}
        placeholder="Bijvoorbeeld: krachttraining, hardlopen, yoga..."
        multiline
      />
