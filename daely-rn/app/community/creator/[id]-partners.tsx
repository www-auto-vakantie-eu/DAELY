    ...
    <AppScreen style={{ backgroundColor: theme.background }}>
      ...
      <View style={[styles.content, { backgroundColor: theme.background }]}>
        <View style={[styles.heroCard, { backgroundColor: theme.card, borderColor: theme.border }]}>
          ...
          <Text style={[styles.heroTitle, { color: theme.titleColor }]}>Partnerintegraties worden voorbereid</Text>
          <Text style={[styles.heroText, { color: theme.subtitleColor }]}>
            Partnerdeals en samenwerkingen binnenkort beschikbaar.
          </Text>
        </View>
        ...
        <View style={[styles.noticeCard, { backgroundColor: theme.card, borderColor: theme.border }]}>
          ...
          <View style={styles.noticeContent}>
            ...
            <Text style={[styles.noticeText, { color: theme.subtitleColor }]}>
              Dit is een preview van wat de DAELY Partnerintegraties zullen worden. Binnenkort voegen we volledige functionaliteit toe.
            </Text>
          </View>
        </View>
      </View>
