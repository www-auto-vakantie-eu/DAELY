...
export const SPORT_DISCIPLINES: SportDiscipline[] = [
  ...
  { id: 'hardlopen', name: 'Hardlopen', category: 'Running', trackingType: 'gps', metrics: ['distance', 'speed'], supportsGps: true, supportsWearables: true, supportsPr: true, supportsChallenges: true, privacyDefault: 'public' },
