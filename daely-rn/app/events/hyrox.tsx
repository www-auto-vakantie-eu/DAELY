      ...
      <View style={styles.content}>
        <View style={[styles.heroCard, { backgroundColor: theme.card, borderColor: theme.border }]}>
          <View style={styles.iconContainer}>
            <MaterialCommunityIcons name="dumbbell" size={48} color="#EF4444" />
          </View>
        ...
        <View style={[styles.infoCard, { backgroundColor: theme.card, borderColor: theme.border }]}>
          <Text style={[styles.infoTitle, { color: theme.titleColor }]}>Wat is HYROX?</Text>
          <Text style={[styles.infoText, { color: theme.subtitleColor }]}>
            HYROX is een internationale fitnessrace die kracht, uithoudingsvermogen en snelheid combineert. DAELY helpt je straks met specifieke voorbereiding, trainingsschema&apos;s en community challenges.
          </Text>
        </View>
        ...
        <View style={[styles.infoCard, { backgroundColor: theme.card, borderColor: theme.border }]}>
          ...
          <View style={styles.bulletRow}>
            ...
            <Text style={[styles.bulletText, { color: theme.subtitleColor }]}>Specifieke HYROX trainingsschema&apos;s</Text>
          </View>
          <View style={styles.bulletRow}>
            <MaterialCommunityIcons name="check-circle" size={18} color="#10B981" />
        ...
        <View style={[styles.infoCard, { backgroundColor: theme.card, borderColor: theme.border }]}>
          ...
          <Text style={[styles.infoText, { color: theme.subtitleColor }]}>
            Voor iedereen die wil deelnemen aan HYROX, van beginners tot gevorderde atleten. DAELY biedt training op elk niveau.
          </Text>
        </View>
        ...
        <View style={[styles.infoCard, { backgroundColor: theme.card, borderColor: theme.border }]}>
          ...
          <Text style={[styles.infoText, { color: theme.subtitleColor }]}>
            DAELY biedt persoonlijke trainingsschema&apos;s, voedingstips, hersteladvies en community support om je optimaal voor te bereiden op je HYROX event.
          </Text>
        </View>
