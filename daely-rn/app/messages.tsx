...
function getClassicGlowTokens(activeThemeId: string) {
  ...
  return {
    isClassic,
    gradient: isClassic ? ['#FFFFFF', '#F8FBFF', '#EFF6FF'] : isForce ? (currentTheme.gradients.aurora || ['#FFFFFF', '#FFF1F2', '#FFE4E6']) : currentTheme.gradients.aurora || ['#E8E6FF', '#D0CCFF', '#B8B4FF'],
    titleColor: isClassic ? '#0F172A' : (currentTheme.colors.auroraTitle || (isForce ? '#7F1D1D' : '#1E1B4B')),
    subtitleColor: isClassic ? '#475569' : (currentTheme.colors.auroraSubtitle || (isForce ? '#B91C1C' : '#4A3A8C')),
    ...
    secondaryButtonColor: isClassic ? '#2563EB' : isForce ? '#DC2626' : '#8B5CF6',
  };
}
