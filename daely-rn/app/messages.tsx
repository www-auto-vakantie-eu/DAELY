...
function getClassicGlowTokens(activeThemeId: string) {
  ...
  return {
    ...
    secondaryButtonColor: isClassic ? '#2563EB' : isForce ? '#DC2626' : isSahara ? '#C89B72' : isRetro ? '#1B2E6B' : isSapphire ? '#3B82F6' : isRuby ? '#B8325A' : isCoral ? '#F9736B' : isMarble ? '#6B7280' : '#8B5CF6',
