...
export const HERO_BACKGROUND_OPTIONS: HeroBackgroundOption[] = [
  ...
  { id: 'levelUp', label: 'Level Up', source: require('../assets/images/theme-level-up.png'), unlockLabel: 'Ontgrendel bij level 5', category: 'achievements', rarity: 'rare' },
  { id: 'trophyRoom', label: 'Trophy Room', source: require('../assets/images/theme-trophy-room.png'), unlockLabel: 'Ontgrendel na je eerste challenge win', category: 'achievements', rarity: 'legendary' },
  { id: 'heroEnergy', label: 'Hero Energy', source: require('../assets/images/theme-hero-energy.png'), unlockLabel: 'Ontgrendel bij 10 voltooide workouts', category: 'performance', rarity: 'epic' },
  { id: 'raceDay', label: 'Race Day', source: require('../assets/images/theme-race-day.png'), unlockLabel: 'Ontgrendel tijdens challenge week', category: 'sport', rarity: 'legendary' },
  { id: 'dataPulse', label: 'Data Pulse', source: require('../assets/images/theme-data-pulse.png'), unlockLabel: 'Ontgrendel na 14 dagen tracking', category: 'performance', rarity: 'rare' },
  { id: 'gymBlackout', label: 'Gym Blackout', source: require('../assets/images/theme-gym-blackout.png'), unlockLabel: 'Ontgrendel met 20 krachttrainingen', category: 'sport', rarity: 'epic' },
  { id: 'footballMatchday', label: 'Football Matchday', source: require('../assets/images/theme-football-matchday.png'), unlockLabel: 'Ontgrendel via voetbalprofiel', category: 'sport', rarity: 'rare' },
  { id: 'neonNight', label: 'Neon Night', source: require('../assets/images/theme-neon-night.png'), unlockLabel: 'Ontgrendel met 5 avondtrainingen', category: 'premium', rarity: 'epic' },
];